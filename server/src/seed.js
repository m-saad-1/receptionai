...
const BusinessConfig_1 = require("./models/BusinessConfig");
...
async function seed() {
    try {
        ...
        // Clear existing data
        await BusinessConfig_1.BusinessConfig.deleteMany({});
        console.log('Cleared existing BusinessConfigs');
        // Insert new data
        await BusinessConfig_1.BusinessConfig.insertMany(personasData);
